...
class XSExceptionTest extends PHPUnit_Framework_TestCase
{
	...
	public function test__toString()
	{
		...
		$this->assertEquals('[XSException] XSExceptionTest.php(15): Test without code', strval($e1));
		$this->assertEquals('[XSException] XSExceptionTest.php(23): Test with code(S#400)', '' . $e2);
	}
}
